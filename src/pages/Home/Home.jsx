      ...
      >
        ...
        <div className="row">
          ...
          >
            <div>
              <p>
                Are you fedup by collecting and carrying all your reports to
                your doctor and want something that can store all your medical
                reports categorically?
                <br />
                We will store all your medical reports on the cloud in different
                categories so that you can access them anywhere anytime without
                any hassle of finding them. <br />
                With Us?{" "}
              </p>
            </div>
            <div>
